...
![GitHub pull requests](https://img.shields.io/github/pr-raw/SEA-group/Geometry-model-extraction-demo)
...
It seems that *.geometry* has less information then *.primitives*, I guess WG's tool would need their corresponding *.visual* file for the conversion. Meanwhile we have never had *.visual* files of the shells. Since those models look simple, I will try to make a tool by myself.
