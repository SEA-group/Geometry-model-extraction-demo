% version 2021.03.10.a
% requires NormalConvertor_Mk2.m

%% debug attributes bloc
clc
clear
primFileName = 'Process/CPA001_Shell_AP.primitives';      % file before conversion
frameFileName = 'Frames/CPA001_Shell_AP.geometry';    % a true grometry file as example
geomFileName = 'Process/CPA001_Shell_AP.geometry';    % file after conversion
shellType = 1;                                                                            % 1 for AP, 2 for HE, 3 for SAP
