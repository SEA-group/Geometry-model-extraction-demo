...
clc
clear
fileName= 'Queue_Primitives/CPA001_Shell_AP.primitives';
...
clear cursor sectionCount currentSectionNameLength;

%% read sections

% prepare a folder to stock temporary files
 if ~exist('temps_primitives/', 'dir') 
    mkdir('temps_primitives/') 
 end
...
%             save(['temps_primitives/', num2str(indSect), '_armor_unknown.mat'], 'data_unknown');
        save(['temps_primitives/', num2str(indSect), '_armorlist_id.mat'], 'Armor_ID');
        save(['temps_primitives/', num2str(indSect), '_armorlist_unknown.mat'], 'Armor_unknown');
        save(['temps_primitives/', num2str(indSect), '_armorlist_count.mat'], 'Armor_count');
        save(['temps_primitives/', num2str(indSect), '_armorlist_vertices.mat'], 'Armor_vertices');
...
%             clear indVert data_unknown data_count Armor_unknown Armor_vertices;    
    ...
    elseif strcmp(sectionClass{indSect}(1: 7), 'indices')
        ...
        if isequal(data_type(1: 6), [108 105 115 116 0 0]')     % if type is list
            ...
            save(['temps_primitives/', num2str(indSect), '_indices_indices16.mat'], 'data_Indices_mat');
        ...
        elseif isequal(data_type(1: 6), [108 105 115 116 51 50]')       % if type is list32
            ...
            save(['temps_primitives/', num2str(indSect), '_indices_indices32.mat'], 'data_Indices_mat');
        ...
        save(['temps_primitives/', num2str(indSect), '_indices_groups.mat'], 'data_group_mat');
...
%                     data_vertices_mat(indVert,10)=typecast(uint8([primCode(cursor+68+(indVert-1)*32+28), primCode(cursor+68+(indVert-1)*32+29), primCode(cursor+68+(indVert-1)*32+30), primCode(cursor+68+(indVert-1)*32+31)]), 'single');
            ...
            save(['temps_primitives/', num2str(indSect), '_vertices_xyznnnuvtb.mat'], 'data_vertices_mat');
...
%                     data_vertices_mat(indVert,9)=typecast(uint8([primCode(cursor+68+(indVert-1)*36+32), primCode(cursor+68+(indVert-1)*36+33), primCode(cursor+68+(indVert-1)*36+34), primCode(cursor+68+(indVert-1)*36+35)]), 'single');
            ...
            save(['temps_primitives/', num2str(indSect), '_vertices_xyznnnuvr.mat'], 'data_vertices_mat');
...
%                     data_vertices_mat(indVert,10)=typecast(uint8([primCode(cursor+68+(indVert-1)*37+33), primCode(cursor+68+(indVert-1)*37+34), primCode(cursor+68+(indVert-1)*37+35), primCode(cursor+68+(indVert-1)*37+36)]), 'single');
            ...
            save(['temps_primitives/', num2str(indSect), '_vertices_xyznnnuviiiwtb.mat'], 'data_vertices_mat');
        ...
        elseif isequal(data_type(1: 7), [120 121 122 110 117 118 0]') % if the type is xyznuv (alpha model)
            ...
            save(['temps_primitives/', num2str(indSect), '_vertices_xyznnnuv.mat'], 'data_vertices_mat');
    ...
    elseif strcmp(sectionClass{indSect}(1: 5), 'cmodl')
        ...
        save(['temps_primitives/', num2str(indSect), '_unknown.mat'], 'data_mat');
